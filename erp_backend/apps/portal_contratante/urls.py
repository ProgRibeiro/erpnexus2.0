...
urlpatterns = [
    ...
    path('prestadores/', views.PrestadoresDisponiveisView.as_view(), name='contratante-prestadores'),
    path('auditoria/', views.RelatorioAuditoriaView.as_view(), name='contratante-auditoria'),
