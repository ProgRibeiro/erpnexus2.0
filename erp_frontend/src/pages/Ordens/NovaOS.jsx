      ...
      <Space direction="vertical" size={16} style={{ width: "100%" }}>
        <Card bordered={false} style={panelStyle} bodyStyle={{ padding: 20 }}>
          <div style={{ alignItems: "center", display: "flex", justifyContent: "space-between", gap: 16 }}>
            <div>
              ...
              <Title level={1} style={{ margin: "4px 0 0", fontSize: 26, fontWeight: 800 }}>
                Nova Ordem de Serviço
              </Title>
            </div>
            <Space>
              <Button onClick={() => navigate("/ordens")} style={{ borderRadius: 8 }}>
                Cancelar
              </Button>
              <Button
                type="primary"
        ...
        <Form form={form} layout="vertical" onFinish={criarOS} disabled={loading}>
          <Row gutter={[16, 16]}>
            <Col xs={24} lg={16}>
              <Card bordered={false} style={panelStyle} bodyStyle={{ padding: 20 }}>
                <Title level={4} style={{ marginTop: 0 }}>Dados da OS</Title>
                <Row gutter={16}>
                  <Col xs={24} md={12}>
                    <Form.Item
                      label="Cliente"
            ...
            <Col xs={24} lg={8}>
              <Card bordered={false} style={panelStyle} bodyStyle={{ padding: 20 }}>
                <Title level={4} style={{ marginTop: 0 }}>Execução</Title>
